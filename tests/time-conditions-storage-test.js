...
async function idbRouteDB(fake) {
  ...
  ['src/js/quality.js', 'src/js/collection-stats.js', 'src/js/time-conditions.js', 'src/js/condition-stats.js', 'src/js/core.js', 'src/js/coverage-grid.js', 'src/js/storage.js']
...
async function main() {
  ...
  section('9. 화면 — 설정 탭 · 통계 · 달력 (실제 settings.js / statistics.js / calendar.js)');
  {
    ...
    ['src/js/quality.js', 'src/js/collection-stats.js', 'src/js/time-conditions.js', 'src/js/condition-stats.js', 'src/js/core.js',
