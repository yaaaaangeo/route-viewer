...
(function (root, factory) {
  ...
  const PLACE_TYPES = Object.freeze({
    ...
    school_zone: Object.freeze({
      ...
      // 학교 POI 를 찾았다고 주변 전체를 어린이보호구역이라고 단정하지 않는다 —
      // 실제 보호구역 지정 데이터가 없으면 "학교 인접 도로"로만 부르고 그 사실을 밝힌다.
      unverifiedNote: '어린이보호구역 지정 여부는 지도 데이터로 확인되지 않았어요 — 보호구역 여부 확인 필요. 현장 표지와 제한속도를 따르세요.',
